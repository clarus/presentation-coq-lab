...
# Converts dia files into .eps files
#
# $(call convert-dia,<dia file>,<eps/pdf file>,[gray])
convert-dia	= $(INKSCAPE) --without-gui $(if $(filter %.pdf,$2),--export-pdf,--export-eps)='$2' '$1'
